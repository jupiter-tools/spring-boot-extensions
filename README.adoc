...
class TempalteServiceTest {
    ...
    void invokeEmbeddedWebServer() {
        ...
        TemplateService templateService =
            new TemplateService(restTemplate, "http://localhost:" + port + "/templates/make");
        // Act
        String test = templateService.make();
        // Assert
        assertThat(test).isEqualTo("${default_template}");
    }
